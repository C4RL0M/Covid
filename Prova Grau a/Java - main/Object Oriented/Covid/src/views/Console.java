...
public class Console {
    ...
    public Console mainMenu(Console console)throws CarlosQueueException {
    ...
    public Console patientMenu(Console console)throws CarlosQueueException {
    ...
    public Console queueMenu(Console console)throws CarlosQueueException {
    ...
    public void addVacPatient() throws CarlosQueueException {
        Scan scan = new Scan();
        try {
